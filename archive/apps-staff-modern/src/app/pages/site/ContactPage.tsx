          ...
          <div className="flex flex-wrap gap-3">
            {contact.socials.map(s => (
              <a key={s.url} href={s.url} target="_blank" rel="noreferrer"
                className="flex flex-col items-center gap-2 w-24 p-3 rounded-lg bg-card border-2 border-border hover:scale-105 transform transition-all">
                <span className="w-10 h-10 rounded-full bg-foreground/5 flex items-center justify-center text-sm font-bold">
