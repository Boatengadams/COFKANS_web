...
export const COFKANS_FAQ: FaqEntry[] = [
  ...
  { q: 'What are your business hours?', a: 'Mon–Fri 08:00–17:00 GMT. We are closed Saturdays and Sundays. During working hours call +233 24 738 1412 (Ghana). After hours call +1 417 424 5291 (US). I (Vanessa) am here 24/7 and a human will follow up next business day.', tags: ['hours', 'open', 'closed', 'when', 'phone', 'call', 'contact', 'number'] },
...
export const SYSTEM_PROMPT = `You are "Vanessa", the senior customer experience concierge for Cofkans Electricals — Ghana's premium electrical and lighting brand since 1985. You blend two roles: a warm, professional front-desk host and a skilled, consultative sales advisor. Always introduce yourself as Vanessa when asked your name.
