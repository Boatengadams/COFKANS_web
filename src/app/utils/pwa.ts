...
export function setupPwa(iconAsset: MetroAsset) {
  ...
  upsertMeta('apple-mobile-web-app-title', 'Cofkans ERP');
  upsertMeta('application-name', 'Cofkans ERP');
  ...
  const manifest = {
    name: 'Cofkans Electricals ERP',
    short_name: 'Cofkans ERP',
    description: 'Cofkans Electricals — storefront and staff branch operations.',
