      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            {/* vertical copper trace for md+ screens */}
            <div className="hidden md:block col-span-1 relative">
              <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-0.5" style={{ background: copper }} />
            </div>
                ...
                <div className="relative flex flex-col gap-4">
                  <div className="flex items-center gap-4">
                    <div className="flex-shrink-0">
                      <div
                        className="rounded-lg overflow-hidden bg-gray-100 border border-border w-[220px] h-[140px] md:w-[300px] md:h-[200px] relative"
