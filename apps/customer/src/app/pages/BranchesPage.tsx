...
export function BranchesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      {branches.length === 0 && <div className="rounded-2xl border-2 border-dashed border-border p-10 text-center text-muted-foreground">No branches are currently available.</div>}
    </div>
  );
}
