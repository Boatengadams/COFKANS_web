...
import type { FirestoreUser, FirestoreProduct } from '@/lib/firestore-schema';
...
export const PersonalizedRecommendations: React.FC<PersonalizedRecommendationsProps> = ({
  ...
  const loadRecommendations = async () => {
    ...
    try {
      ...
      const recommendedIds = await getPersonalizedRecommendations(user.uid, simplifiedProducts);
