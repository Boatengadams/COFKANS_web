  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 bg-black/70 backdrop-blur-md z-[150] overflow-y-auto overscroll-contain [-webkit-overflow-scrolling:touch]"
      >
        {/* min-h-full (not 100vh) keeps the bottom reachable on iOS Safari, where
            100vh sits behind the browser toolbar; safe-area pad clears the home bar. */}
        <div className="min-h-full p-4 sm:p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))]">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Comparison Table */}
            <div className="bg-card rounded-b-3xl border-2 border-border shadow-xl overflow-x-auto [-webkit-overflow-scrolling:touch]">
