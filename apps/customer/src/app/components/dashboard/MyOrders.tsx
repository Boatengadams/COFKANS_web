  ...
  const loadOrders = async () => {
    ...
    try {
      ...
      try {
        ...
        // Keep order history working when the optional composite index has not
        // been deployed yet; sort the user's private result set locally.
        snapshot = await getDocs(query(collection(db, 'orders'), where('userId', '==', user.uid)));
      }
