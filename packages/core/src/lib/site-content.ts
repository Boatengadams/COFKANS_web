...
export const SITE_CONTENT_DEFAULTS: SiteContent = {
  contact: {
    phone: '053-6622095',
    whatsapp: '053-6622095',
    email: 'cofkanselectricals1@gmail.com',
    supportEmail: 'cofkanselectricals1@gmail.com',
    careersEmail: 'cofkanselectricals1@gmail.com',
    address: 'Asuoyeboa, Kumasi, Ashanti Region, Ghana',
  ...
  about: {
    ...
    body: [
      ...
      '## What we do',
      "We supply, install and service architectural lighting, industrial electrical solutions, inverters, switchgear and the everyday accessories that keep Ghanaian homes, sites and businesses powered. Our main showroom in Asuoyeboa, Kumasi carries the full range; our branch network puts quality stock within easy reach across Ghana.",
  ...
  privacy: {
    ...
    body: [
      ...
      '## Your rights',
      'You can request a copy of your data, correct anything inaccurate, withdraw marketing consent, or close your account at any time. Email cofkanselectricals1@gmail.com and we will respond within 30 days.',
      '## Cookies',
  ...
  terms: {
    ...
    body: [
      'By using the Cofkans Electricals customer portal or our showroom services, you agree to these Terms of Service. Please read them carefully — they cover ordering, payment, delivery, warranty, returns and acceptable use.',
      '## Orders & pricing',
  ...
  support: {
    ...
    body: [
      ...
      '## Reach us',
      'Use the **Call** or **WhatsApp** buttons on the Contact page, or email **cofkanselectricals1@gmail.com**. Walk-ins are welcome at our Asuoyeboa showroom during business hours.',
    ].join('\n\n'),
  },
  careers: {
    ...
    openings: [],
    applyHowTo: "Send your CV and a short note about the kind of role you're looking for to **cofkanselectricals1@gmail.com** with the subject line *Career enquiry*. We acknowledge every application.",
  },
  landing: {
